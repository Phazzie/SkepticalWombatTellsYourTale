        ...
        <GlassCard className="mb-6 border-app-border space-y-3">
          ...
          {[
            ...
            <label key={i} className="flex cursor-pointer items-center gap-3 group">
              <span
                className={`relative flex h-5 w-5 shrink-0 items-center justify-center rounded-md border transition-all group-focus-within:ring-2 group-focus-within:ring-neon-lime group-focus-within:ring-offset-2 group-focus-within:ring-offset-app-bg ${
                  value
