              ...
              return (
                <Card key={session.id} className="overflow-hidden p-0">
                  <button
                    ...
                    className="w-full px-5 py-4 text-left transition hover:bg-app-surface-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent"
