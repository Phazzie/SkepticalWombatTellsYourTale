                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-1 ml-3 shrink-0">
                        <button
                          ...
                          className="rounded-lg p-1.5 text-app-fg-muted transition hover:bg-app-surface-strong hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-lime"
                        >
                        ...
                        <button
                          ...
                          className="rounded-lg p-1.5 text-app-fg-muted transition hover:bg-red-900/30 hover:text-red-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
                        >
                          <span aria-hidden="true">🗑️</span>
                        </button>
                        <span aria-hidden="true" className="text-app-fg-muted transition-colors group-hover:text-indigo-300 ml-1">→</span>
                      </div>
                    </div>
                  </Link>
                )}
