    ...
    <div className="mt-6 bg-gray-900 border border-gray-700 rounded-xl p-5">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-gray-800 border border-gray-600 rounded px-3 py-2 text-sm text-white placeholder-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:border-indigo-500 transition-shadow"
        />
        <button
          onClick={onSearch}
          disabled={searching}
          aria-busy={searching}
          className="rounded bg-indigo-600 px-4 py-2 text-sm text-white disabled:cursor-not-allowed disabled:opacity-60 hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 transition-shadow"
        >
