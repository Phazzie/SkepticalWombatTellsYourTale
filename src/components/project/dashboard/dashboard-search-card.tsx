    ...
    <div className="mt-6 bg-gray-900 border border-gray-700 rounded-xl p-5">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          disabled={searching}
          aria-busy={searching}
          className="rounded bg-indigo-600 px-4 py-2 text-sm text-white disabled:cursor-not-allowed disabled:opacity-60 hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
        >
