  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
      <Link
        ...
        className="bg-indigo-600 hover:bg-indigo-700 rounded-xl p-5 text-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
      >
      ...
      <Link
        ...
        className="bg-gray-800 hover:bg-gray-700 rounded-xl p-5 text-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
      >
