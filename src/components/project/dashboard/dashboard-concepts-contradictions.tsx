            ...
            {pendingConcepts.slice(0, 5).map((concept) => (
              <div key={concept.id} className="rounded-xl bg-app-surface-muted p-3 border border-app-border">
                ...
                <button
                  ...
                  className="text-xs text-neon-lime/70 hover:text-neon-lime mt-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-lime focus-visible:ring-offset-1 focus-visible:ring-offset-gray-900 rounded"
                >
                  ✓ Approve
                </button>
              </div>
