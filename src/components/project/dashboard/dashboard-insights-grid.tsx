              ...
              <div key={tangent.id} className="bg-gray-800 rounded-lg p-3">
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="text-xs text-green-400 hover:text-green-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800 rounded-sm"
                  >
                    ✓ Resolved
                  </button>
                </div>
            ...
            {openGaps.slice(0, 5).map((gap) => (
              <div key={gap.id} className="bg-gray-800 rounded-lg p-3">
                ...
                <button
                  ...
                  aria-label={`Resolve gap: ${gap.description.slice(0, 30)}${gap.description.length > 30 ? '...' : ''}`}
                  className="text-xs text-green-400 hover:text-green-300 mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800 rounded-sm"
                >
                  ✓ Resolved
                </button>
              </div>
