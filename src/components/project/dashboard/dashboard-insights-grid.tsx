              ...
              <div key={tangent.id} className="bg-gray-800 rounded-lg p-3">
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="text-xs text-green-400 hover:text-green-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400"
                  >
                    ✓ Resolved
                  </button>
                </div>
            ...
            {openGaps.slice(0, 5).map((gap) => (
              <div key={gap.id} className="bg-gray-800 rounded-lg p-3">
                ...
                <button
                  ...
                  className="text-xs text-green-400 hover:text-green-300 mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400"
                >
                  ✓ Resolved
                </button>
              </div>
