      ...
      <div className="bg-gray-900 border border-gray-700 rounded-xl p-5">
        ...
        {pendingTangents.length === 0 ? (
          ...
          <div className="space-y-3">
              ...
              <div key={tangent.id} className="bg-gray-800 rounded-lg p-3">
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    aria-label={`Resolve thread: ${tangent.thread}`}
            ...
            <Link href={`/project/${id}/tangents`} className="text-xs text-indigo-400 hover:text-indigo-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded px-1 -ml-1 inline-block">
              View all tangents →
            </Link>
          </div>
        )}
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-xl p-5">
        ...
        {openGaps.length === 0 ? (
          ...
          <div className="space-y-3">
            ...
            <Link href={`/project/${id}/gaps`} className="text-xs text-indigo-400 hover:text-indigo-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded px-1 -ml-1 inline-block">
              View all gaps →
            </Link>
          </div>
        )}
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-xl p-5">
        ...
        {newPatterns.length === 0 ? (
          ...
          <div className="space-y-3">
            ...
            <Link href={`/project/${id}/patterns`} className="text-xs text-indigo-400 hover:text-indigo-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded px-1 -ml-1 inline-block">
              View all patterns →
            </Link>
          </div>
        )}
